...
class MtgB1000TimeIO:
    """Sets the time on an MTG-B1000, including the second analogue dial.
    ...
    additional second-dial sequence that the MTG-B1000 requires after the
    main time command.
    """
    ...
    async def set_second_dial(connection: ConnectionProtocol) -> None:
        ...
        """
        MtgB1000TimeIO.connection = connection
        logger.info("MtgB1000TimeIO: starting second dial sequence")
        ...
        logger.info("MtgB1000TimeIO: second dial sequence complete")
