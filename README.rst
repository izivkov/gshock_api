...
The new API is the **send_app_notification** function. See the `examples/api_test.py <https://github.com/izivkov/gshock_api/blob/main/src/examples/api_tests.py>`_ file for usage examples.
