...
The new API is `send_app_notification` function in the
`https://github.com/izivkov/gshock_api/blob/main/src/gshock_api/gshock_api.py#453-456>`_ file.
 See the `examples/api_test.py <https://github.com/izivkov/gshock_api/blob/main/src/examples/api_tests.py>`_ file for usage examples.
